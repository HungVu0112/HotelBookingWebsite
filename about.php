...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        <h2 class="fw-bold h_font text-center">ABOUT US</h2>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
                ...
                <p>
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Labore illum facilis vel, provident eum sint voluptatum!
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Labore illum facilis vel, provident eum sint voluptatum!
                </p>
            </div>
    ...
    <div class="container px-4">
        <div class="swiper mySwiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide bg-white text-center overflow-hidden rounded mb-5">
